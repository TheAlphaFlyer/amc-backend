...
function initMapWidgetInSection(section) {
    ...
    section.querySelectorAll(".dj_map_wrapper").forEach((wrapper) => {
        ...
        // Force custom projection options
        options.map_srid = null; // Disable SRID transform in defaultCenter
        // We override the map creation/view opts in the class mostly, 
        // but let's pass it here or modify the class to use this projection by default
