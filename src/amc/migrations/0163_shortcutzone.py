...
def seed_shortcut_zones(apps, schema_editor):
    ...
    ShortcutZone.objects.get_or_create(
        ...
        defaults={"polygon": gwangjin_poly, "active": True, "description": "Original Gwangjin shortcut zone"},
    )
    ShortcutZone.objects.get_or_create(
        name="Migeum Shortcut",
        defaults={"polygon": migeum_poly, "active": True, "description": "Original Migeum shortcut zone"},
    )
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("polygon", django.contrib.gis.db.models.fields.PolygonField(dim=2, srid=3857)),
