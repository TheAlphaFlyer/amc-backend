    ...
    templates = [
        {
            ...
            "objectives": [
                ...
                {
                    "cargo_keys": ["Limestone", "LimestoneRock"],
                    "dest_names": [],
                    "src_names": [],
                    "ceiling": 500,
                    "reward_weight": 10,
                ...
                {
                    "cargo_keys": ["Fuel", "WoodPlank_14ft_5t"],
                    "dest_names": [],
                    "src_names": [],
                    "ceiling": 200,
                    "reward_weight": 20,
