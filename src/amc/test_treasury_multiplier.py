...
class TreasuryMultiplierTestCase(SimpleTestCase):
    """Tests for the power curve treasury multiplier."""
    ...
    def test_negative_balance_returns_zero(self):
        result = calculate_treasury_multiplier(-1_000_000, equilibrium=50_000_000)
        self.assertEqual(result, 0.0)
    ...
    def test_higher_sensitivity_gives_steeper_curve(self):
        low_sens = calculate_treasury_multiplier(
            25_000_000, equilibrium=50_000_000, sensitivity=1.0
        )
        high_sens = calculate_treasury_multiplier(
            25_000_000, equilibrium=50_000_000, sensitivity=3.0
        )
        self.assertLess(high_sens, low_sens)

    def test_representative_values_default_sensitivity(self):
        at_zero = calculate_treasury_multiplier(
            0, equilibrium=50_000_000, sensitivity=2.0
        )
        ...
        self.assertLessEqual(at_half, 0.25)
        self.assertGreater(at_half, 0.0)

        at_double = calculate_treasury_multiplier(
            100_000_000, equilibrium=50_000_000, sensitivity=2.0
        )
        self.assertEqual(at_double, 2.0)

    def test_ratio_squared_at_default_sensitivity(self):
        result = calculate_treasury_multiplier(
            27_800_000, equilibrium=50_000_000, sensitivity=2.0
        )
        expected = (27_800_000 / 50_000_000) ** 2.0
    ...
    def test_clamped_scaling_factor_ceiling(self):
        treasury_mult = calculate_treasury_multiplier(
            1_000_000_000, equilibrium=100_000_000, sensitivity=2.0
        )
    ...
    def test_bonus_within_expected_range(self):
        ...
        for _ in range(1000):
            ...
            treasury_mult = calculate_treasury_multiplier(
                balance, equilibrium=50_000_000, sensitivity=2.0
            )
