...
DISCORD_LOGS_CHANNEL_ID = int(
    os.environ.get("DISCORD_LOGS_CHANNEL_ID", "1463235712886247465")
)
...
SETWANTED_COOLDOWN_MINUTES = int(os.environ.get("SETWANTED_COOLDOWN_MINUTES", 30))
DISCORD_AUDIT_CHANNEL_ID = int(os.environ.get("DISCORD_AUDIT_CHANNEL_ID", 0))
DISCORD_CRIMINAL_STATS_CHANNEL_ID = int(
    os.environ.get("DISCORD_CRIMINAL_STATS_CHANNEL_ID", 0)
)
